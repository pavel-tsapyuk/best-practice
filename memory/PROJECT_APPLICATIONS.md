...
- **Битрикс24 Коворк/Код и Радиант** — кандидат для ограниченного пилота на отчётах, CRM-сводках и небольших внутренних приложениях. Перед внедрением проверить тариф, права, журнал действий, подтверждение удаления, экспорт/удаление памяти и качество на реальных данных.
- Радиант не считать первоисточником: сведения, влияющие на клиента, деньги, сроки, права доступа или кадровые решения, сверять с актуальными объектами Битрикс24 ([официальное ограничение](https://helpdesk.bitrix24.ru/open/29111338/)).
- Не заменять существующие n8n/API-процессы Коворком только из-за доступности агента; сравнивать надёжность, стоимость и управляемость на одной узкой операции.
